...
<form name="fmemberlist" id="fmemberlist" action="./point_list_update.php" onsubmit="return fmemberlist_submit(this);" method="post">
...
<div class="tbl_head02 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col" id="mb_list_1"><?php echo subject_sort_link('mb_1', '', 'desc') ?>현재 포인트</a></th>
      <th scope="col" id="mb_list_add"> 추가/차감</th>
     <th scope="col" id="mb_list_add"> 사유</th>
    </tr>
    </thead>
    <tbody>
    <?php
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td headers="mb_list_point" class="td_num"><input type="hidden" name="mb_1[<?php echo $i; ?>]"  value="<? echo $row['mb_1'] ?>" ><? echo number_format($row['mb_1']) ?></td>
        <td headers="mb_list_point" class="td_num"><input type="text" name="add[<?php echo $i; ?>]" value="" id="add<?php echo $i; ?>"  size=20></td>
        <td headers="mb_list_point" class="td_num"><input type="text" name="why[<?php echo $i; ?>]" value="" id="why<?php echo $i; ?>" size=70></td>
    </tr>
