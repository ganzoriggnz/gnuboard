...
$sql_search = " where (b.mb_level='26' or b.mb_level='27') and ( (a.co_sale_num >='1' or a.co_free_num >='1' ) and  a.co_begin_datetime = '{$co_begin_datetime}' and a.co_end_datetime = '{$co_end_datetime}')";
