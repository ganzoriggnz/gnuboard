...
<section id="anc_bo_function">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td class="td_grpset">
                <input type="checkbox" name="chk_grp_use_good" value='<?=$board['bo_use_good']?>' id="chk_grp_use_good">
                <label for="chk_grp_use_good">그룹적용</label>
                <input type="checkbox" name="chk_all_use_good" value='<?=$board['bo_use_good']?>' id="chk_all_use_good">
        ...
        <tr>
            ...
            <td class="td_grpset">
                <input type="checkbox" name="chk_grp_use_nogood" value='<?=$board['bo_use_nogood']?>' id="chk_grp_use_nogood">
                <label for="chk_grp_use_nogood">그룹적용</label>
                <input type="checkbox" name="chk_all_use_nogood" value='<?=$board['bo_use_nogood']?>' id="chk_all_use_nogood">
