...
// add_stylesheet('<link rel="stylesheet" href="'.G5_JS_URL.'/font-awesome2/css/all.css">', 0);
$sub_menu = "600000";
if ($_GET['bo_table'] == 'calendar') {
...
// 추천 사용
$is_good = false;
// hulan if($board[bo_use_good])-g doorhoor solison
if ($member['mb_level'] >= $board['bo_use_good'])
    $is_good = true;

// 비추천 사용
$is_nogood = false;
// hulan if($board[bo_use_nogood])-g solison
...
include_once(G5_PATH . '/adm/bbs/board_head.php');
