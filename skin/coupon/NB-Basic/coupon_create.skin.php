...
<div id="bo_v" style="backgroun-color: #fff">
    ...
    <div class="couponbg" >
        ...
        <div style="margin-top: 30px; line-height: 1.5;">
            원가권 <span style="color: blue; "><?php echo $row_set['bo_sale'];?>장</span>, 무료권 <span style="color: blue; "><?php echo $row_set['bo_free']; ?>장</span> 이상 지원시 <span style="color: blue; "><?php echo $row_set['bo_total']; ?>개</span> 업소 선착순으로 업소정보 배너 상단 고정랜덤에 적용됩니다. <br />
            ...
            <table class="coupon-table">
                ...
                <tbody>
                    <tr class="coupon-create-tr">
                        ...
                        <td class="coupon-create-td"><input type="number" name="co_sale_num" id="co_sale_num" value="<?php echo $row['co_sale_num']; ?>" placeholder="" class="form-control coupon_input text-center" <?php if($co_created_datetime > $co_insert_date) { echo 'disabled="disabled"';}  else {echo '';}?>></td>
                    ...
                    <tr class="coupon-create-tr">
                        ...
                        <td class="coupon-create-td" > <input type="number" name="co_free_num" id="co_free_num" value="<?php echo $row['co_free_num']; ?>" placeholder="" class="form-control coupon_input text-center" <?php if($co_created_datetime > $co_insert_date) { echo 'disabled="disabled"';}  else { echo '';}?>></td>
