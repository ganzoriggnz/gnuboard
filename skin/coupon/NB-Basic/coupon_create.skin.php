...
<div id="bo_v" style="backgroun-color: #fff">
    ...
    <div class="coupon_info">
        <form id="fcouponcreate" name="fcouponcreate" action="<?php echo $coupon_action_url ?>" onsubmit="return fcouponcreate_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <input type="hidden" id="co_no" value="<?php echo $co_row['co_no']; ?>">
            ...
            <table class="coupon-table">
                ...
                <tbody>
                    <tr class="coupon-create-tr">
                        ...
                        <td class="coupon-create-td"><input type="number" name="co_sale_num" id="co_sale_num" value="<?php echo $co_row['co_sale_num']; ?>" placeholder="" class="form-control coupon_input text-center"></td>

                        <td class="coupon-create-td" style="border-right: 1px solid #ced4da; text-align: center;"><?php echo $co_row['co_sale_num']; ?></td>
                        <td class="coupon-create-td"><?php echo $diff_s; ?></td>
                    </tr>

                    <tr class="coupon-create-tr">
                        <td class="coupon_label col-form-label">무료권 :</td>
                        <td class="coupon-create-td" > <input type="number" name="co_free_num" id="co_free_num" value="<?php echo $co_row['co_free_num']; ?>" placeholder="" class="form-control coupon_input text-center"></td>

                        <td class="coupon-create-td" style="border-right: 1px solid #ced4da; text-align: center; padding-top: 10px;"><?php echo $co_row['co_free_num']; ?></td>
            ...
            <div class="popup_box4" style="display:none;">aa
