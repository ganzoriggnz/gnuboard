...
$qu = "SELECT COUNT(*) as cnt FROM {$tmp_table} WHERE mb_id='{$member['mb_id']}'";
$row = sql_fetch($qu);
$cnt = $row['cnt'];
?>
...
<<<<<<< HEAD
					...
					<?php
						if($cnt > 0) {
							echo '<a><i class="fa fa-gift"></i><br>수행<br>진행</a>';
						}
						elseif($cnt == 0) {
							echo '<a href="'.G5_BBS_URL.'/board.php?bo_table=free" target="_blank">				
							<i class="fa fa-gift"></i><br>수행<br>진행</a>';
						}
					?>
=======
