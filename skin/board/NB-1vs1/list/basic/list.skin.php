...
if ($list[$i]['mb_id'] == $member['mb_id'] || $is_admin || ($list[$i]['mb_id'] != $member['mb_id'] && $list[$i]['mb_id']=='admin')){
	...
	?>
		<li class="d-md-table-row px-3 py-2 p-md-0 text-md-center text-muted border-bottom<?php echo $li_css;?>">
			...
			<div class="float-right float-md-none d-md-table-cell nw-15 nw-md-auto text-left f-sm font-weight-normal pl-2 py-md-2 pr-md-1">
