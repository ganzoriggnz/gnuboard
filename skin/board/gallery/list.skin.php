...
<? if ($is_category) { ?>
    <form name="fcategory" method="get">
       <td>
       <!-- <a href="<?=$g5['bbs_path']?>/board.php?bo_table=<?=$bo_table?>"><img src="<?=$board_skin_path?>/img/btn_list.gif" border="0" align=absmiddle></a>
            ...
            ?>
                <li class="<?php echo implode(' ', $classes); ?>">
                    <div class="gall_box" style="background-image:url('http://localhost/gnuboard/img/main_bgpicture.png')" style="width: 100%; height: 148px;">
                        ...
                        <?php } ?> -->
                                ...
                                <!-- <p style="font-weight: bold;"><?php
                                                                    ...
                                                                    $zzzzz = sql_query($sql);
                                                                    if ($zzzzz->num_rows > 0) {
                                                                        $publisher = $zzzzz->fetch_array(MYSQLI_ASSOC);
                                                                        echo $publisher['mb_addr1'] . '</p><div style="display: flex; align-items: center; line-height: 1.5;">
                    ...
                    <div class="gall_option">
                        ...
                        <div style="display: flex; align-items: center; justify-content: space-evenly; background-image: url('http://localhost/gnuboard/img/main_780.png'); width: 100%; height: 52px;">
                            <div>
                                <button style="background-color: rgb(255, 255, 255, 0.05); font-size: 10px; font-weight: 100; font-family: 'Roboto', Arial, sans-serif; display: flex; flex-direction: column;align-items: center; justify-content: center; width: 43px; height: 35px; margin-left: 44px; padding: 2px 2px;"><img src="http://localhost/gnuboard/img/baseline-ballot_main-24px.png"><!-- <i class="fa fa-calendar"></i> --> 출근부</button>
                            </div>
                            <div>
                                <button style="background-color: rgb(255, 255, 255, 0.05); font-size: 10px; font-weight: light; display: flex;flex-direction: column; align-items: center; justify-content: center; width: 43px; height: 35px; margin-right: 44px; padding: 2px 2px;"><img src="http://localhost/gnuboard/img/chat_icon_main.png"><!-- <i class="fa fa-comments"></i> --> 후기</button>
                            </div>
                        </div>
                    </div>
                </li>
...
<?php if ($is_checkbox) { ?>
    ...
    <script language="JavaScript">
        ...
        if ('<?php echo $wr_5 ?>') document.fcategory.wr_5.value = '<?php echo $wr_5 ?>';
        if ('<?php echo $wr_4 ?>') document.fcategory.wr_4.value = '<?php echo $wr_4 ?>';
        if ('<?php echo $stx ?>') {
