    ...
    <section id="bo_v_info">
        ...
        <div class="profile_info">
        	...
        	<div class="profile_info_ct">
        		...
        		<strong class="if_date"><span class="sound_only">작성일</span><i class="fa fa-clock-o" aria-hidden="true"></i> <?php echo ' 수정일: '.date("Y.m.d H:i", strtotime($view['wr_last'])) ?></strong>
    		</div>
    	</div>
