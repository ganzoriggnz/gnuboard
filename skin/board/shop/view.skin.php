...
<tr>
	<td  class="td_web_img">    <?php
        ...
        if($v_img_count) {
         ...
         ?></td>
	<?php $action_url = $board_skin_url."/apply.php"; ?>
	<form name="fwrite" id="fwrite" action="<?php echo $action_url ?>" onsubmit="return fwrite_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off" style="width:<?php echo $width; ?>">
	  ...
	  <input type="hidden" name="point" value="<?php echo $member['mb_point'] ?>">
	  <input type="hidden" name="mb_id" value="<?php echo $member['mb_id'] ?>">
	  <input type="hidden" name="wr_8" value="<?php echo $view['wr_8'] ?>">
      <input type="hidden" name="wr_9" value="<?php echo $view['wr_9'] ?>">
	<td valign=top>
		<ul><li>차감 파운드:&nbsp;&nbsp;&nbsp;&nbsp; <?php echo $view['wr_1'] ?></li></ul>
		<ul><li>현재 파운드:&nbsp;&nbsp;&nbsp;&nbsp; <?php  echo $member['mb_point']; ?></li></ul>
...
<?php	if($view['wr_10'] == "Open" && $is_member && $member['mb_point'] >= $view['wr_1']) { ?>
   <div class="btn_confirm">
	...
	if($member['mb_point'] < $view['wr_1'])  echo "<b>파운드가 부족합니다.</b>";
...
$(function() {
    $("a.view_file_download").click(function() {
        var msg = "파일을 다운로드 하시면 파운드가 차감(<?php echo number_format($board['bo_download_point']) ?>점)됩니다.\n\n파운드는 게시물당 한번만 차감되며 다음에 다시 다운로드 하셔도 중복하여 차감하지 않습니다.\n\n그래도 다운로드 하시겠습니까?";
