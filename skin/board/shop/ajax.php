...
<tr>
	...
	<td><input type=image  onclick="Process2(<?php echo $id[$i] ?>)"  src="<?php echo $board_skin_url ?>/img/button-arrow-down-icon.png"> <input type=image  onclick="Process21(<?php echo $id[$i] ?>)" src="<?php echo $board_skin_url ?>/img/button-arrow-up-icon.png">  <input type=image class="btn_b01" onclick="Process3(<?php echo $id[$i] ?>)" src="<?php echo $board_skin_url ?>/img/Windows-Close-Program-icon.png"></td>
</tr>
<?php }
...
<tr style="background:white;border:1px solid #000000;">
	...
	<td  colspan=2>
	<?php if($check == "결제하기") { ?>
	<a href="<?php echo $board_skin_url?>/checkout.php?total_price=<?php echo $total_price?>&check=<?php echo $check?>&myid=<?php echo $member['mb_id']?>" onclick="return popitup('<?php echo $board_skin_url?>/checkout.php?total_price=<?php echo $total_price?>&check=<?php echo $check?>&myid=<?php echo $member['mb_id']?>')"><IMG src="<?php echo $board_skin_url ?>/img/purple-credit-card.png"> <?php echo $check?></a></td>
	<?php } ?>
