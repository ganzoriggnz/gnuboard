...
// 작성자 회원 프로필 이미지
$mb_pf_img = get_member_profile_img($view['mb_id']);
preg_match('% src="([^"]+)"%i', $mb_pf_img, $matches);
$mb_pf_src = $matches[1];
// 글 작성시 선택한 아바타가 있다면?
$mb_pf_img = $view['wr_link1'] 
    ? '<img src="'.$view['wr_link1'].'" onerror="this.src=\''.$mb_pf_src.'\'">' 
    : $mb_pf_img;
?>
...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="bo_v_info">
        ...
        <div class="profile_info">
            <div class="pf_img"><?php echo $mb_pf_img ?></div>
    ...
    <section id="bo_v_atc">
        ...
        <?php
        // 파일 출력
        $v_img_count = count(array_filter(array_column($view['file'], 'view')));
        if($v_img_count) {
    ...
    <section id="bo_v_file">
        ...
        ?>
            <li>
                ...
                <span class="bo_v_file_cnt"><?php echo $view['file'][$i]['content'] ?> | SIZE: <?php echo $view['file'][$i]['size'] ?> | DATE: <?php echo $view['file'][$i]['datetime'] ?> | <?php echo $view['file'][$i]['download'] ?>회 다운로드</span>
            </li>
        <?php
            }
        }
