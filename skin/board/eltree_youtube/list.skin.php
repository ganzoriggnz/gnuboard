...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div id="bo_btn_top">
        ...
        <ul class="btn_bo_user">
            ...
            <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn btn-primary" title="글쓰기"><i class="fa fa-pencil" aria-hidden="true"></i><?php if(!G5_IS_MOBILE) echo " 글쓰기" ?><span class="sound_only">글쓰기</span></a></li><?php } ?>
