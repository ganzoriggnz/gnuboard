...
if ($w == '') {
	...
	$title_msg = '챕터등록';
	$preface_subject = str_replace('Re: ', '', $subject);
	$subject = '';
} else if($w == "u") {
	$title_msg = '수정하기';
}
...
<section id="bo_w" class="f-de font-weight-normal mb-4">
    <h2 class="sr-only"><?php echo $title_msg ?></h2>
	...
	<li class="list-group-item border-top-0">
		<h5 class="font-weight-bold en"><?php echo $title_msg ?></h5>
	</li>
	<?php if ($is_name) { ?>
	...
	<?php if($preface_subject) { //챕터 등록시 ?>
		<li class="list-group-item">
			<div class="form-group row mb-0">
				<label class="col-md-2 col-form-label">표지</label>
				<div class="col-md-10">
					<p class="form-control-plaintext">
						<?php echo $preface_subject ?>
					</p>
				</div>
			</div>
		</li>
	...
	<?php if($w == "r" || $write['wr_reply']) { //챕터일 때?>
		<li class="list-group-item">
			<div class="form-group row mb-0">
				<label class="col-md-2 col-form-label" for="as_tag">챕터 순서</label>
				<div class="col-md-4">
