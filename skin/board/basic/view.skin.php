...
<article id="bo_v" style="width:<?php echo $width; ?>">
        ...
        <div id="bo_v_top">
            ...
            <ul class="btn_bo_user bo_v_com">
                ...
                <?php if ($reply_href) { ?><li><a href="<?php echo $reply_href ?>" class="btn_b01 btn" title="답변"><i
                            class="fa fa-reply" aria-hidden="true"></i><span class="sound_only">답변</span></a></li>
                <?php } ?>
    ...
    <section id="bo_v_atc">
        ...
        <div id="bo_v_act">
            <?php if ($gr_id!="attendance" && $good_href && $bo_table!="job") { ?>
        ...
        <div id="bo_v_act">
            ...
            <!-- <?php if($board['bo_use_nogood']) { ?><span class="bo_v_nogood"><i class="fa fa-thumbs-o-down"
                    aria-hidden="true"></i><span
                    class="sound_only">비추천</span><strong><?php echo number_format($view['wr_nogood']) ?></strong></span>
                    <?php } ?> -->
