...
<tr>
    ...
    <th>계급 마크</th>
    <th>레벨</th>
    <th class="th_point">페니</th>
</tr>
</thead>
<tbody>
<?php
$rank_rows = 100; //출력 수
$sql = " select * from {$g5['member_table']} where mb_peny > '{$row['mb_peny']}' {$sql_common} order by mb_peny desc, mb_today_login desc limit {$rank_rows} ";
...
$point = number_format($row['mb_peny']);
