		...
		<?php if ($bo_table != "pointrank" && $bo_table != "penyrank" && $bo_table != "levelrank" && $bo_table != "boardadmlist" && $bo_table != "mypage") { ?>
			...
			<div>
				<ul class="mb-0 pagination justify-content-center en">
					...
					<?php } ?>
					<?php echo na_paging(G5_IS_MOBILE ? $config['cf_mobile_pages'] : $config['cf_write_pages'], $page, $total_page, get_pretty_url($bo_table, '', $qstr . isset($_GET['alert']) ? '&alert=true&amp;page=' : '&amp;page=')); ?>
