...
#bo_cate a {border-radius: 2px; font-size:12px; color:#000; width:7.105rem; height:39px; display: flex; align-items:center; justify-content:center; margin-left: 0px;}
...
#bo_cate a {border-radius: 2px; font-size:12px; color:#000; width:5.8rem; height:45px; display: flex; align-items:center; justify-content:center; margin-left: 0px;}
