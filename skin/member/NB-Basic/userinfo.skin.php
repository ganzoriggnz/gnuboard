...
<nav id="user_cate" class="sly-tab font-weight-normal mb-2">
    ...
    <dl class="dl-horizontal">
        ...
        <dt>프로필 사진</dt>
            ...
            <dt>쿠폰</dt><dd><a href="#"><i class="fa fa-paperclip"></i> <span class="hidden-xs">쿠폰</span></a></dd>
            <dt>지역-업종</dt><dd>태릉-휴게텔</dd><dt>제휴기간</dt><dd>2017-04-12 ~ 2020-12-19 - [ <a href="#" target="_blank"><font color="red"><b>3일 남음</b></font></a> ]</dd>
            <!-- <dt>제휴 연장 안내</dt>
            <dd>
            ...
            <dt>연락처</dt><dd>01042535226<br>(프로필과 배너에 출력되니 항상 최신번호로 유지해주세요) &nbsp;&nbsp;&nbsp;<!-- <a onclick="window.open('//localhost/gnuboard/bbs/member_hp_change.php?mb_id=juho3141','전화번호 변경요청','width=300,height=300,scrollbars=no,padding=0, margin=0, top=300,left=800');" style="color:#000;background-color:#efefef; padding:5px; border:1px solid #696969; border-radius:5px; text-decoration:none">
