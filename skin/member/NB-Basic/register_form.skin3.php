...
<div class="register m-auto f-de">
	...
	<form id="fregisterform" name="fregisterform" action="<?php echo $register_action_url ?>" onsubmit="return fregisterform_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off">
		...
		<?php }  ?>
		<!-- <?php
				// 닉네임수정일이 지나지 않았다면  hulan tailbar
			...
			<li class="list-group-item pt-3 pt-sm-4">
				...
				<div class="form-group row">
					...
					<div class="form-group row">
						...
						<div class="col-sm-6">
							<p class="form-control-plaintext f-de text-muted pb-0">
								공백없이 한글,영문,숫자만 가능 (한글 10자, 영문20자 이하 가능)
							</p>
						</div>
...
<!-- ASDFASDFASDASDFASDFASDFDDD   -->
				...
				<div class="form-group row">
					...
					<div class="col-sm-6 <?php echo G5_IS_MOBILE ? 'd-flex mt-2' : 'row'; ?>" >
						...
						style="color:#000;background-color:#efefef; padding:5px; border:1px solid #696969; border-radius:5px; text-decoration:none; <?php echo G5_IS_MOBILE ? 'height: fit-content; width !important: 38%;' : ''; ?>" >
