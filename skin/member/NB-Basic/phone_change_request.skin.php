...
<div class="tbl_head02 tbl_wrap" style="margin-top:50px">
	...
	<tr><td style="background-color:#f0f0f0;padding:5px">변경 전화번호</td>
		<td><input type="text" name="new_hp" id="new_hp" value=""  style="width:120px;height:25px; text-align:left; margin-right:25px; border:1px solid #b5b5b5"  size="14" maxlength="14"></td></tr>
	</table>
<br/>
