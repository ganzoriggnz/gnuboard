...
function captcha_html($class="captcha")
{
    ...
    if(is_mobile())
        $html .= "\n".'<button type="button" id="captcha_reload" style="width:29px; height:29px; background: url(../../../img/captcha2.png) 31px 31px;background-size: 33px;"><span></span>새로고침</button>';
    else
