...
// 로고 이미지
$tset['logo_img1'] = ($tset['logo_img1']) ? $tset['logo_img1'] : '../img/logo1.png';
$tset['logo_img1'] = na_url($tset['logo_img1']);
$tset['logo_img2'] = ($tset['logo_img2']) ? $tset['logo_img2'] : '../img/logo2.png';
$tset['logo_img2'] = na_url($tset['logo_img2']);
$tset['logo_img3'] = ($tset['logo_img3']) ? $tset['logo_img3'] : '../img/mlogo.png';
$tset['logo_img3'] = na_url($tset['logo_img3']);
...
?>
<div class="wrapper m-auto overflow-hidden" style="padding-bottom: 110px; margin-bottom: 110px;">
    <div id="nt_header">
        <div id="nt_sticky">
            <?php
		// LNB
