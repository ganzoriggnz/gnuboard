...
$data=array (
  ...
  array (
    ...
    array (
      ...
      array (
        'text' => '오피-강남영토',
        'href' => 'http://192.168.1.2/gnuboard/bbs/board.php?bo_table=opigangnam_at',
        'icon' => 'fa-calendar',
        'target' => '_self',
        'line' => '',
        'sp' => '',
      ...
      array (
        'text' => '오피-비강남',
        'href' => 'http://192.168.1.2/gnuboard/bbs/board.php?bo_table=opibigangnam_at',
        'icon' => 'fa-calendar',
        'target' => '_self',
        'line' => '',
        'sp' => '',
      ...
      array (
        'text' => '건마-서울영토',
        'href' => 'http://localhost/gnuboard/bbs/board.php?bo_table=gonmaseoul_at',
        'icon' => 'fa-calendar',
        'target' => '_self',
        'line' => '',
        'sp' => '',
      ...
      array (
        'text' => '키스방-전국영토',
        'href' => 'http://localhost/gnuboard/bbs/board.php?bo_table=kissall_at',
        'icon' => 'fa-calendar',
        'target' => '_self',
        'line' => '',
        'sp' => '',
  ...
  array (
    ...
    array (
      ...
      array (
        'text' => '오피-비강남',
        'href' => 'http://localhost/gnuboard/bbs/board.php?bo_table=opibigangnam_re',
        'icon' => 'fa-commenting-o',
        'target' => '_self',
        'line' => '',
        'sp' => '',
      ...
      array (
        'text' => '핸플/패티쉬영토',
        'href' => 'http://localhost/gnuboard/bbs/board.php?bo_table=show_re',
        'icon' => 'fa-commenting-o',
        'target' => '_self',
        'line' => '',
        'sp' => '',
  ...
  array (
    ...
    array (
      ...
      array (
        'text' => '출석체크',
        'href' => 'http://localhost/gnuboard/plugin/attendance/attendance.php',
        'icon' => 'fa-comments',
        'target' => '_self',
        'line' => '공지사항',
        'sp' => '1',
      ...
      array (
        'text' => '왕궁 게시판',
        'href' => 'http://localhost/gnuboard/bbs/blank.php',
        'icon' => 'fa-comments',
        'target' => '_self',
        'line' => '',
        'sp' => '',
      ...
      array (
        'text' => '아이템샵',
        'href' => 'http://localhost/gnuboard/bbs/board.php?bo_table=shop',
        'icon' => 'fa-comments',
        'target' => '_self',
        'line' => '',
        'sp' => '',
      ...
      array (
        'text' => '트위터 인증',
        'href' => 'http://localhost/gnuboard/bbs/board.php?bo_table=twitter',
        'icon' => 'fa-comments',
        'target' => '_self',
        'line' => '',
        'sp' => '',
  ...
  array (
    ...
    array (
      ...
      array (
        'text' => '파운드페니로전환',
        'href' => 'http://localhost/gnuboard/bbs/point.php',
        'icon' => 'fa-headphones',
        'target' => '_self',
        'line' => '',
        'sp' => '',
      ...
      array (
        'text' => '파편조각페니로전환',
        'href' => 'http://localhost/gnuboard/bbs/point2.php',
        'icon' => 'fa-headphones',
        'target' => '_self',
        'line' => '',
        'sp' => '',
      ...
      array (
        'text' => '장터게시판',
        'href' => 'http://localhost/gnuboard/bbs/board.php?bo_table=market',
        'icon' => 'fa-headphones',
        'target' => '_self',
        'line' => '',
        'sp' => '',
      ...
      array (
        'text' => '구인구직 게시판',
        'href' => 'http://localhost/gnuboard/bbs/board.php?bo_table=job',
        'icon' => 'fa-headphones',
        'target' => '_self',
        'line' => '',
        'sp' => '',
      ...
      array (
        'text' => '실장업무게시판',
        'href' => 'http://localhost/gnuboard/bbs/board.php?bo_table=work_board',
        'icon' => 'fa-headphones',
        'target' => '_self',
        'line' => '',
        'sp' => '',
  ...
  array (
    ...
    array (
      ...
      array (
        'text' => '계급 랭킹',
        'href' => 'http://localhost/gnuboard/bbs/board.php?bo_table=levelrank',
        'icon' => 'fa-trophy',
        'target' => '_self',
        'line' => '',
        'sp' => '',
      ...
      array (
        'text' => '페니 랭킹',
        'href' => 'http://localhost/gnuboard/bbs/board.php?bo_table=penyrank',
        'icon' => 'fa-trophy',
        'target' => '_self',
        'line' => '',
        'sp' => '',
  ...
  array (
    ...
    array (
      ...
      array (
        'text' => '영화 ',
        'href' => 'http://192.168.1.2/gnuboard/bbs/board.php?bo_table=movie',
        'icon' => 'fa-play-circle',
        'target' => '_self',
        'line' => '',
        'sp' => '',
      ...
      array (
        'text' => 'TV영상',
        'href' => 'http://192.168.1.2/gnuboard/bbs/board.php?bo_table=tv',
        'icon' => 'fa-play-circle',
        'target' => '_self',
        'line' => '',
        'sp' => '',
