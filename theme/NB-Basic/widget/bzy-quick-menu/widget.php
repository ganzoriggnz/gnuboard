...
<div class="f-de font-weight-normal" style="margin-right: 58px; border-radius: 5px; padding: 10px 0 0 10px;">
    ...
    <div id="links_list" style="display: flex; flex-wrap: wrap; justify-content: space-between;">
        <div style="padding: 0px 14px;">
            ...
            <div id="link" style="display: flex; flex-direction: row; align-items: center;" class="glow">
                <!-- <i class="fa fa-angle-right" style="margin-right: 3px;"></i> -->
        ...
        <div style="padding: 0px 14px;">
            <div id="link" style="display: flex; flex-direction: row; align-items: center; margin-bottom: 9px;" class="glow">
                <!-- <i class="fa fa-angle-right" style="margin-right: 3px;"></i> -->
                <img src="<?php echo G5_URL ?>/img/baseline-card_giftcard-24px.png" alt="card-giftcard" style="margin-right: 5px; border-color: #707070;">
                <a href="<?php echo G5_BBS_URL ?>/blank7.php" style="color: #BFAF88;">아이템 샵</a>
            </div>
            <div id="link" style="display: flex; flex-direction: row; align-items: center; margin-bottom: 9px;" class="glow">
                <!-- <i class="fa fa-angle-right" style="margin-right: 3px;"></i> -->
            ...
            <div id="link" style="display: flex; flex-direction: row; align-items: center;" class="glow">
                <!-- <i class="fa fa-angle-right" style="margin-right: 3px;"></i> -->
                <img src="<?php echo G5_URL ?>/img/baseline-chat-24px.png" alt="chat" style="margin-right: 5px; border-color: #707070;">
        ...
        <div style="padding: 0px 14px;">
            ...
            <div id="link" style="display: flex; flex-direction: row; align-items: center; margin-bottom: 9px;" class="glow">
                <!-- <i class="fa fa-angle-right" style="margin-right: 3px;"></i> -->
                <img src="<?php echo G5_URL ?>/img/baseline-ballot-24px.png" alt="ballot" style="margin-right: 5px; border-color: #707070;">
                <a href="<?php echo G5_BBS_URL ?>/mission.php" style="color: #BFAF88;">일일미션</a>
            </div>
            <div id="link" style="display: flex; flex-direction: row; align-items: center;" class="glow">
                <!-- <i class="fa fa-angle-right" style="margin-right: 3px;"></i> -->
                <img src="<?php echo G5_URL ?>/img/baseline-forum-24px.png" alt="forum" style="margin-right: 5px; border-color: #707070;">
