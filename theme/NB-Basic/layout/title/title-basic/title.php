...
<!-- Page Title -->
<div id="nt_title" class="font-weight-normal <?php echo G5_IS_MOBILE ? 'mx-3' : ''; ?>" <?php if(!G5_IS_MOBILE){ echo 'style="margin-bottom: 8px;"'; } else {echo 'style="margin-bottom: 5px;"' ;}?> >
