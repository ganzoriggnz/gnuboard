...
<div id="nt_menu_wrap">
    ...
    <header id="header_mo" class="d-block d-md-none">
        ...
        <div id="search_mo" class="collapse">
            <div class="p-3 mb-0 px-sm-4 d-block d-lg-none bg-light border-bottom">
        ...
        <!-- <div class="me-icon order-1 me-li<?php echo ($is_index) ? ' on' : ' on'; ?>">
				...
				<div class="order-3 me-icon me-li on">
    ...
    <nav id="nt_menu" class="d-none d-md-block font-weight-normal">
        ...
        <div class="nt-container">
            <div class="d-flex" style="min-width: 1500px;">
                <div class="order-2 flex-grow-1 me-list">
                    <ul class="m-0 row me-ul nav-slide">
                                    ...
                                    <ul class="dropdown-menu sub-1dul" style="justify-content: flex-start; position: absolute; white-space: nowrap; background-color: #fff; padding: 0px 10px; -webkit-box-shadow: 0 6px 12px rgba(0, 0, 0, .175)">
										...
										<?php } ?>										 -->
                                            <?php if ($me1['text'] == "실장님 정보공유") {
                                                        ...
                                                        ?>
                                                            ...
                                                            <li class="sub-2dli<?php echo ($me2['on']) ? ' on' : ''; ?>">
                                                                <a href="<?php echo $me2['href'] ?>" class="dropdown-item me-sh sub-2da" target="<?php echo $me2['target'] ?>">
                                                                    ...
                                                                    <img src="<?php echo G5_URL ?>/img/solid/<?php echo substr($me2['icon'], 3, strlen($me2['icon'])) ?>.svg" style="height :14px;" alt="<?php echo substr($me2['icon'], 3, strlen($me2['icon'])) ?>" />
                                                                    <?php echo $me2['text']; ?>
                                                                </a>
                                                            </li>
                                                        <?php } ?>
                                                ...
                                                <li class="dropdown-submenu sub-1dli<?php echo ($me1['on']) ? ' on' : ''; ?>" style="flex:1;">
                                                    <a href="<?php echo $me1['href']; ?>" data-toggle="dropdown" class="dropdown-item <?php echo count($me1['s']) > 1 ? ' dropdown-toggle' : '' ?> me-sh sub-1da<?php echo (isset($me1['s'])) ? ' sub-icon' : ''; ?>" style="<?php echo strpos($me1['text'], '오피-전라/제주') === false && strpos($me1['text'], '휴게텔-경상/전라/제주') === false && strpos($me1['text'], '건마-경상/전라/제주') === false && strpos($me1['text'], '술집-지방영토') === false && strpos($me1['text'], '안마-지방영토') === false && strpos($me1['text'], '핸플/패티쉬영토') === false && strpos($me1['text'], '휴게텔 경상/전라/제주') === false && strpos($me1['text'], '건마 경상/전라/제주') === false ? '' : 'border-bottom-color: #707070;' ?>" target="<?php echo $me1['target']; ?>">
                                                        <img src="<?php echo G5_URL ?>/img/solid/<?php echo substr($me1['icon'], 3, strlen($me1['icon'])) ?>.svg" style="height :14px;" alt="<?php echo substr($me1['icon'], 3, strlen($me1['icon'])) ?>" />
                                                        <?php echo $me1['text']; ?>
                                                    </a>
                        ...
                        <?php if (!$menu_cnt) { ?>
                            <li class="order-2 flex-grow-1 me-li">
                        ...
                        <div style="display: flex; flex-direction: row; justify-content: space-between; width: <?php echo $is_member ? '27.3691%;' : '9.12103' ?>">
                            ...
                            <?php if ($is_member) { ?>
                                ...
                                <li class="p-0 col me-li me-icon right_border">
                                    <a class="me-a f-md en win_memo" href="<?php echo G5_BBS_URL ?>/memo_friend.php?kind=friends" target="_blank" title="친구추가">
                ...
                <div class="order-3 me-icon me-li on" style="width:43px;">
                    <a href="javascript:;" onclick="sidebar_open('sidebar-menu'); return false;" class="me-a f-md" title="마이메뉴">
                        <!-- <i class="fa fa-toggle-on" aria-hidden="true"></i> -->
    ...
    <!-- 전체 메뉴 -->
    <nav id="nt_menu_all" class="bg-white d-none d-md-block f-de font-weight-normal">
        <h3 class="sr-only">전체 메뉴</h3>
        <div id="menu_all" class="collapse">
            <div class="px-3 pt-4 nt-container px-sm-4 px-xl-0">
                            ...
                            ?>
                                <ul class="p-3">
                                    ...
                                    ?>
                                        ...
                                        <?php if ($me1['line']) { //구분라인 
                                        ?>
                                            <li class="pt-2 pb-1 sub-line text-black-50"><?php echo $me1['line']; ?></li>
                                        <?php } ?>

                                        <li class="pb-1 sub-li">
                                            <a href="<?php echo $me1['href']; ?>" class="sub-a<?php echo ($me1['on']) ? ' on text-primary' : ''; ?>" target="<?php echo $me1['target']; ?>">
                                                <img src="<?php echo G5_URL ?>/img/solid/<?php echo substr($me1['icon'], 3, strlen($me1['icon'])) ?>.svg" style="height :14px;" aria-hidden="true" alt="<?php echo substr($me1['icon'], 3, strlen($me1['icon'])) ?>" />
                ...
                <div class="text-center">
                    <a href="javascript:;" class="border-0 btn" data-toggle="collapse" data-target="#menu_all" title="닫기">
