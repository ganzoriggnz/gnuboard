...
?>
    ...
    <li class="me-li<?php echo ($me['on']) ? ' active' : ''; ?>">
        ...
        <div style="<?php if( strstr($me['href'], $member['mb_6'])) echo "font-weight: bold; color: red; "; ?>">
            ...
            <a class="<?php if( strstr($me['href'], $bo_table)) echo"activesubs" ?> cat_2_bg" title="<?php echo $me['text'].' 정보 | 밤의제국 bamje.com';?>" style="<?php if( strstr($me['href'], $bo_table)) echo"background-color: #ffd345" ?>;"
