...
<section id="ol_after" class="ol">
    <header id="ol_after_hd">
        ...
        <?php if (($is_admin == 'super' || $is_auth) && G5_BZY_CHECK) {  ?><a href="<?php echo correct_goto_url(G5_ADMIN_URL); ?>" class="btn_admin btn" title="관리자"><i class="fa fa-cog fa-spin fa-fw"></i><span class="sound_only">관리자</span></a><?php }  ?>
    </header>
