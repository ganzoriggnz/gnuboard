...
<aside id="ol_after" class="ol">
    ...
    <div id="ol_after_hd">
        ...
        <div id="ol_after_btn">
	        <?php if (($is_admin == 'super' || $is_auth) && G5_BZY_CHECK) { ?><a href="<?php echo G5_ADMIN_URL ?>" class="btn_admin"><i class="fa fa-cog fa-spin fa-fw"></i><span class="sound_only">관리자</span></a><?php } ?>
