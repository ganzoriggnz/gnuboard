...
<aside id="visit">
    ...
    <?php if ($is_admin == "super" && G5_BZY_CHECK) { ?><a href="<?php echo G5_ADMIN_URL ?>/visit_list.php" class="btn_admin btn"><i class="fa fa-cog fa-spin fa-fw"></i><span class="sound_only">상세보기</span></a></a><?php } ?>
</aside>
