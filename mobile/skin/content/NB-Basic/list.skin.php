...
<div id="bo_search" class="collapse<?php echo ($wset['search_open'] || $stx) ? ' show' : ''; ?>">
	<div class="p-2 mx-3 mb-3 border alert bg-light p-sm-3 mx-sm-0">
...
if ($category_option) {
	...
	$category_option = '<li' . $ca_start . '><a class="px-3 py-2" href="' . $category_href . '">전체</a></li>';
	for ($i = 0; $i < $ca_count; $i++) {
		...
		$category_option .= '<li' . $ca_active . '><a class="px-3 py-2" href="' . $category_href . '?sca=' . urlencode($category) . '">' . $ca_msg . $category . '</a></li>';
	}

?>
	<!-- 분류 시작 { -->
	<nav id="bo_cate" class="mb-2 sly-tab font-weight-normal">
		...
		<div class="px-3 px-sm-0">
			<div class="d-flex">
				...
				<div>
					<a href="javascript:;" class="px-3 py-2 sly-btn sly-prev ca-prev">
						<i class="fa fa-angle-left" aria-hidden="true"></i>
						<span class="sr-only">이전 분류</span>
					</a>
				</div>
				<div>
					<a href="javascript:;" class="px-3 py-2 sly-btn sly-next ca-next">
...
<div id="bo_list" class="mb-4">
	...
	<form name="fqalist" id="fqalist" action="./qadelete.php" onsubmit="return fqalist_submit(this);" method="post">
		...
		<!-- 게시판 페이지 정보 및 버튼 시작 { -->
		<div id="bo_btn_top" class="clearfix pl-3 pr-2 mb-2 f-de font-weight-normal px-sm-0">
			<div class="d-flex align-items-center">
				...
				<div class="btn-group" role="group">
					...
					<?php if ($write_href) { ?>
						<a href="<?php echo $write_href ?>" class="py-1 btn btn_b01 nofocus" title="문의 등록" rolo="button">
		...
		<div class="mb-0 na-table d-none d-md-table w-100">
			<div class="<?php echo $head_class ?> d-md-table-row">
				...
				<div class="pl-2 d-md-table-cell nw-10 pr-md-1">이름</div>
				<div class="d-md-table-cell nw-5 pr-md-1">상태</div>
				<div class="d-md-table-cell nw-8 pr-md-1">날짜</div>
			</div>
		</div>

		<ul class="mb-4 na-table d-md-table w-100">
			<?php
			$list_cnt = count($list);
		...
		<!-- 페이지 -->
		<div class="px-3 font-weight-normal px-sm-0">
