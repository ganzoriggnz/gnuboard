...
<div id="bo_v">
    ...
    <div id="scrap" class="new_win">
        ...
        <ul id="scrap_ul" class="list_01">
            ...
            <li>
                <a href="<?php echo $list[$i]['opener_href_wr_id'] ?>" target="_blank" class="scrap_tit"
                ...
                <span class="scrap_datetime"><i class="fa fa-clock-o" aria-hidden="true"></i>
                    <?php echo $list[$i]['ms_datetime'] ?></span>
                <a href="<?php echo $list[$i]['del_href'];  ?>" onclick="del(this.href); return false;"
                    class="scrap_del"><i class="fa fa-trash-o" aria-hidden="true"></i><span
                        class="sound_only">삭제</span></a>
            </li>
            <?php } ?>
            <?php if (count($list) == 0) echo "<li class=\"empty_list\">자료가 없습니다.</li>"; ?>
        </ul>
