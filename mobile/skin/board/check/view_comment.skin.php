...
<button type="button" class="cmt_btn" id="bo_cm"><i class="material-icons" aria-hidden="true">comment</i> 댓글</button>
<!-- 댓글 리스트 -->
<section id="bo_vc">
    ...
    for ($i=0; $i<count($list); $i++) {
        ...
        $cmt_depth = ""; // 댓글단계
        $cmt_reply = strlen($list[$i]['wr_comment_reply']);
    ...
    ?>
    <article id="c_<?php echo $comment_id ?>" <?php if ($cmt_reply) { ?><?php } ?> data-depth="<?php echo $cmt_reply; ?>" data-reply="<?php echo $list[$i]['wr_comment'].$list[$i]['wr_comment_reply']; ?>">
    ...
    <aside id="bo_vc_w" class="bo_vc_w">
        ...
        <div class="bo_vc_w_info">
            <div>
                ...
                <input type="text" name="wr_name" value="<?php echo get_cookie("ck_sns_name"); ?>" id="wr_name" required class="frm_input required" size="25" placeholder="이름" autocomplete="off">
                <label for="wr_password" class="sound_only">비밀번호<strong> 필수</strong></label>
                <input type="password" name="wr_password" id="wr_password" required class="frm_input required" size="25"  placeholder="비밀번호" autocomplete="new-password">
                <?php } else { ?>
                <span class="bo_vc_w_name"><?php echo $member['mb_nick']; ?></span>
                <?php } ?>
