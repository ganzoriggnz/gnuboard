...
<div id="memo_list" class="mb-4">
    ...
    <div class="tbl_head02 tbl_wrap">
        <table>
            ...
            <tbody>
                <?php
	$result = "SELECT a.*, c.mb_level FROM {$g5['coupon_table']} a INNER JOIN $at_table b ON a.mb_id = b.mb_id INNER JOIN {$g5['member_table']} c ON a.mb_id = c.mb_id WHERE a.co_begin_datetime='{$co_begin_datetime}' AND a.co_end_datetime='{$co_end_datetime}' AND b.wr_is_comment='0' AND c.mb_level = '27' and (a.co_sale_num > '0' or a.co_free_num > '0')"; 
				...
				while ($row1 = sql_fetch_array($sql1)){
					...
					if($row1['cos_accept'] == 'N' && $row1['cos_alt_quantity'] == '0') 
                        { echo '<li><a data-toggle="modal"
                            ...
                            <div class="modal fade" id="couponDelete<?php echo $delcnt; ?>" tabindex="-1" role="dialog"
                                style="position: fixed; top: 30%; left: 20%;">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content" style="width: 350px; height: 250px;">
                                        <form id="fcoupondelete<?php echo $delcnt; ?>" name="fcoupondelete"
                                            action="<?php echo $coupon_delete_action_url; ?>"
                                            onsubmit="return fcoupondelete_submit(this);" method="post"
                                            ...
                                            <div class="modal-footer" style="border-top: none;">
                                                <div style="margin: 0px auto 10px auto; text-align: center;">
                                                    <button type="submit" accesskey="s" class="btn btn-primary"
                                                        style="width: 150px; font-size: 14px;">확인</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                            ...
                            <div class="modal fade" id="couponAlert<?php echo $altcnt; ?>" tabindex="-1" role="dialog"
                                style="position: fixed; top: 30%; left: 0%;">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content" style="width: 650px; height: 400px;">
                                        ...
                                        <div class="modal-body" style="padding: 5px 0px;">
                                            ...
                                            <div style="margin-left: 30px; margin-top: 5px;">
                                                <?php echo "현재 경고횟수 : ".$res1['cos_alt_quantity'];?>
                                                <form id="fcouponalert<?php echo $altcnt; ?>" name="fcouponalert"
                                                    ...
                                                    <div style="margin-left:30px; margin-top: 30px;">
                                                        ...
                                                        <input type="number" name="cos_alt_quantity"
                                                            id="cos_alt_quantity" class="form-control"
                                                            style="background: #EFEFEF; width: 60px; height: 30px; display: inline-block; text-align: center; margin-left: 30px; padding-left:25px; font-size: 12px;"
                                                            value="<?php echo $res1['cos_alt_quantity']; ?>" />
                                                        <input type="submit" name="change" id="change" value="확인"
                                                ...
                                                <div style="margin: 10px 10px 10px 0px;">
													...
													for($i=0; $row = sql_fetch_array($res); $i++) { ?>
                                                            <tr class="alert-tr">
                                                                <td class="col-xs-3 alert-td">
                                                                    <?php echo $row['alt_created_datetime']; ?></td>
                                                                <td class="col-xs-2 alert-td">
                                                                    <?php echo $row['cos_entity']; ?></td>
                                                                <td class="col-xs-3 alert-td">
                                                                    <?php echo $row['alt_reason']; ?></td>
                                                                <td class="col-xs-2 alert-td">
                                                                    <?php echo $row['alt_created_by']; ?></td>
                                                                <td class="col-xs-2 alert-td">
                                                                    <?php echo $row['cos_alt_quantity']; ?></td>
                                                            </tr>
                                                            <?php
													} ?>
                                                        </tbody>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="width: 350px; height: 300px;">
                ...
                <div class="modal-body">
                    <form id="fcouponsend" name="fcouponsend" action="<?php echo $coupon_sent_action_url; ?>"
                        onsubmit="" method="post" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <div style="margin-left: 30px; margin-top: 5px;"><?php echo "업소명 :";?>
                            <input type="text" name="cos_entity" id="cos_entity" value=""
                                style="border:none; outline: none; width: 100px;">
                        </div>
                        <div style="margin-left:120px; margin-top: 20px;">받는사람 닉네임</div>
                        <div style="margin-left:30px; margin-top:10px;">
                            <input type="text" name="cos_nick" id="mb_nick" class="form-control"
                                style="background: #dcdcdc; display:inline; width: 160px;" />
                            <input type="button" name="check_id" id="check_id" value="닉네임 확인" class="btn"
                                style="background: #6495ED; display:inline; width: 100px;" />
                        </div>
                ...
                <div class="modal-footer" style="border-top: none;">
                    <div style="margin-left: 140px; margin: 0px auto 10px auto; text-align: center;">
                        <button type="button" id="btn_send" accesskey="s" class="btn btn-primary"
                            style="width: 150px;">보내기</button>
                    </div>
                </div>
            </div>
        </div>
