...
if ($is_admin)
    echo '<div id="bo_list_wrap" style="width: 1200px;"><div class="ctt_admin"><a href="'.G5_ADMIN_URL.'/contentform.php?w=u&amp;co_id='.$co_id.'" class="btn_admin btn">내용 수정</a></div></div>';
?>
