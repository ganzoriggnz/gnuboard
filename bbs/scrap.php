...
$scrap_skin_path = get_skin_path('member', $config['cf_member_skin']);
$scrap_skin_url  = get_skin_url('member', $config['cf_member_skin']);
$skin_file = $scrap_skin_path.'/scrap.skin.php';
